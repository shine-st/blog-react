        ...
        <Router history={browserHistory}>
            <Route path="/" component={Main}>
                ...
                <Route path="backend" component={BackendMain}>
                    ...
                    <Route path="edit-post" component={EditPostContainer} onEnter={EditPostContainer.editPostListEnter(store)}/>
                    <Route path="edit-post/:id" component={EditPostContainer} onEnter={EditPostContainer.editPostEnter(store)}/>
                </Route>
            </Route>
        </Router>
    </Provider>,
